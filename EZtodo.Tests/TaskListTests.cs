...
";
        ...
        public void PrependToTask()
        {
            ...
            taskList.PrependToTask(2, "Up front ");
            var task = taskList.GetTask(2);

            Assert.Equal("Up front this is task 2", task.Body);
        }

        [Fact]
        public void AppendToTask()
        {
            var taskList = new TaskList()
            {
                "this is task 1",
            ...
            taskList.AppendToTask(2, " in back");
            var task = taskList.GetTask(2);
